 <?php
    ...
    function getProducts()
    {
        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            // Initialize name as an empty string in case no result is found
            $name = 'Unknown Farmer';
    
            // Get the farmer's name associated with the product
            ...
            // If the query is successful and returns a result, update the name
