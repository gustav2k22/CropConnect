...
} else if (a === 'Greater Accra') {
    var array = ['Accra Metropolitan', 'Ga South', 'Ga Central', 'Ga East', 'Ga West', 'Tema Metropolitan', 'Ashaiman', 'Ledzokuku-Krowor', 'Adenta', 'Ningo-Prampram'];
}
                         ...
                         echo "<div class='container'>
                              <div class='row'>
                                   ...
                                   <div class='col-md-4'>
                                        ...
                                        <p class='price'>Price<i class='fa fa-rupee fa-1x'></i> : $product_price  GHS</p>
