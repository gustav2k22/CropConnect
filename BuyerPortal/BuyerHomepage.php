...
<head>
	...
	<script>
        function state() {
            var stateValue = document.getElementById('states').value;
            var districtArray = [];

            switch (stateValue) {
    case '31':
        districtArray = ['Accra Metropolitan', 'Ga Central', 'Ga East', 'Ga West', 'Tema Metropolitan', 'Ashaiman', 'Ledzokuku-Krowor', 'Adenta', 'Ningo-Prampram', 'Shai Osudoku'];
        break;
    case '01':
        districtArray = ['Kumasi Metropolitan', 'Obuasi Municipal', 'Ejisu-Juaben', 'Kwabre East', 'Bosomtwe', 'Bekwai Municipal', 'Atwima Nwabiagya', 'Atwima Kwanwoma', 'Afigya-Kwabre'];
        break;
    case '02':
        districtArray = ['Cape Coast Metropolitan', 'Komenda-Edina-Eguafo-Abirem', 'Mfantsiman', 'Abura-Asebu-Kwamankese', 'Assin North', 'Assin South', 'Twifo-Hemang-Lower Denkyira'];
        break;
    case '03':
        districtArray = ['New Juaben', 'Koforidua', 'Suhum', 'Nsawam-Adoagyiri', 'Kwahu West', 'Kwahu South', 'Yilo Krobo', 'Akwapim North', 'Akwapim South'];
        break;
    case '04':
        districtArray = ['Sekondi-Takoradi Metropolitan', 'Ahanta West', 'Nzema East', 'Jomoro', 'Ellembelle', 'Shama', 'Wassa Amenfi East', 'Wassa Amenfi West'];
        break;
    case '05':
        districtArray = ['Sefwi Wiawso', 'Bia West', 'Bia East', 'Juabeso', 'Bodi', 'Aowin', 'Suaman', 'Sefwi Akontombra'];
        break;
    case '06':
        districtArray = ['Tamale Metropolitan', 'Yendi Municipal', 'Savelugu', 'Kumbungu', 'Gushegu', 'Saboba', 'Bimbilla', 'Karaga', 'Zabzugu'];
        break;
    case '07':
        districtArray = ['Bole', 'West Gonja', 'North Gonja', 'Sawla-Tuna-Kalba', 'Central Gonja', 'East Gonja'];
        break;
    case '08':
        districtArray = ['Bolgatanga Municipal', 'Bongo', 'Kassena-Nankana East', 'Kassena-Nankana West', 'Bawku Municipal', 'Garu-Tempane', 'Pusiga', 'Binduri'];
        break;
    case '09':
        districtArray = ['Wa Municipal', 'Wa East', 'Wa West', 'Sissala East', 'Sissala West', 'Lambussie', 'Nandom'];
        break;
    case '10':
        districtArray = ['Ho Municipal', 'Ketu South', 'Ketu North', 'Hohoe Municipal', 'Akatsi South', 'Akatsi North', 'Keta', 'Adaklu', 'Afadzato South'];
        break;
    case '11':
        districtArray = ['Techiman', 'Kintampo North', 'Kintampo South', 'Nkoranza North', 'Nkoranza South', 'Pru East', 'Pru West', 'Sene East', 'Sene West'];
        break;
    case '12':
        districtArray = ['Sunyani Municipal', 'Berekum', 'Dormaa Central', 'Dormaa East', 'Dormaa West', 'Tano North', 'Jaman North', 'Jaman South', 'Wenchi'];
        break;
    case '13':
        districtArray = ['Goaso', 'Asunafo South', 'Asunafo North', 'Tano South', 'Tano North', 'Asutifi North', 'Asutifi South'];
        break;
    case '14':
        districtArray = ['Dambai', 'Nkwanta North', 'Nkwanta South', 'Jasikan', 'Krachi East', 'Krachi West', 'Krachi Nchumuru', 'Biakoye'];
        break;
    case '15':
        districtArray = ['Nalerigu', 'Bunkpurugu', 'Chereponi', 'West Mamprusi', 'East Mamprusi', 'Yunyoo-Nasuan'];
        break;
    default:
...
<body>
	...
	<div class="instaid">
		...
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">info@cropconnect.com</a></div>
