    ...
    <div class="box">
        <form action="BuyerEditProfile.php" method="post">
            ...
            <table align = "center">
                ...
                <tr align = "center">
                    <td><label><b>Ghana Card No. :</b></label></td>
                ...
                <tr colspan =2 align = "center">
                    <td colspan =2><input type = "submit" name="editProf" value= "Edit Profile" id="editProfileForm" onclick="openEditProfile()"></td>
                </tr>
            </table>
            
        </form>
        <iframe id="editProfileFrame" style="display:none; width:100%; height:600px;"></iframe>

    <script>
        function openEditProfile() {
            // Open the Buyereditprofile.php in the iframe
            document.getElementById('editProfileFrame').style.display = 'block';
            document.getElementById('editProfileFrame').src = 'BuyerEditProfile.php';
        }
    </script>
