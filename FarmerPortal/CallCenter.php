...
<body>
     ...
     <body>
          ...
          <div class="card">
               <h4 class="card-header text-center font-weight-bold">Contact Us</h4>
               <div class="card-body">
                    <h5 class="card-title text-center font-weight-bold">You Can Contact on the Following Social Media Platforms</h5>
                    <div class="card-deck">
                         <div class="card">

                         <div class="card-body">
                         <a href="#" ><h5 class="card-title font-weight-bold text-center"><i class="fa fa-phone fa-rotate-vertical" aria-hidden="true"></i></h5>
                                   <p class="card-text text-center"><strong>(+233) 0242345678</strong></p></a>
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                              <a href="#" ><h5 class="card-title font-weight-bold text-center"><i class="fa fa-whatsapp fa-rotate-vertical" aria-hidden="true"></i></h5>
                                   <p class="card-text text-center"><strong>(+233) 0242345678</strong></p></a>
                              </div>
                         </div>
                         <div class="card">
                              ...
                              <div class="card-body">
                              <a href="#" ><h5 class="card-title font-weight-bold text-center"><i class="fa fa-facebook fa-rotate-vertical" aria-hidden="true"></i></h5>
                                   <p class="card-text text-center" ><strong>CropConnect</strong></p></a>
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                              <a href="#" ><h5 class="card-title font-weight-bold text-center"><i class="fa fa-instagram fa-rotate-vertical" aria-hidden="true"></i></h5>
                                   <p class="card-text text-center" ><strong>CropConnect</strong></p></a>
                          ...
                          <div class="card">
                              ...
                              <div class="card-body">
                              <a href="#" ><h5 class="card-title font-weight-bold text-center"><i class="fa fa-linkedin fa-rotate-vertical" aria-hidden="true"></i></h5>
                                   <p class="card-text text-center" ><strong>CropConnect</strong></p></a>
