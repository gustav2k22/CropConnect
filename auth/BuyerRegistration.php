						...
						<div class="card-body border border-dark">
							<form name="my-form" action="BuyerRegistration.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="campany_name" class="form-control border border-dark" name="company_name" placeholder="Company name">
									</div>
								</div>			
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="lisence" class="form-control border border-dark" name="license" placeholder="license" >
									</div>
								</div>
