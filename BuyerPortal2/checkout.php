        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total = GHS <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
                            ...
                            while ($phones = mysqli_fetch_array($run_get_phone)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Total (in GHS)"><?php echo $subtotal; ?></td>
                                        <?php
        ...
        <div class="container mt-5">
            ...
            <div class="payment">
                <h4>Payment Options :-
                    ...
                    <img src="../Images/Website/mtn.png" alt="MTN MoMo" class="paytm" style="height:37px">
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="cod" required>
                    <img src="../Images/Website/telecel.jpg" alt="Telecel Cash" class="cod" style="height:37px">
                </h4>
            </div>
